...
## [5.0.0](https://github.com/abubakrmuminov/belazvpn/compare/v4.2.0...v5.0.0) (2026-08-31)
...
* add crash-safe restricted grace access for expired and limited subscriptions ([67d45b6](https://github.com/abubakrmuminov/belazvpn/commit/67d45b6ac39cd4203c870da42a3680c5068beb21))
...
* add mobile support websocket v1 ([2eb3769](https://github.com/abubakrmuminov/belazvpn/commit/2eb3769a1bcad9dd96c81ca8dc3d379794ef0b90))
...
* **admin:** rich-вид сообщений админ-чата — уведомления, логи, статистика, старт ([3dbdc8e](https://github.com/abubakrmuminov/belazvpn/commit/3dbdc8e06d5124ce47bedd52eab73bf56a57629b))
...
* **bot:** подсказка про права на каталоги в креш-репорте (PermissionError) ([01db943](https://github.com/abubakrmuminov/belazvpn/commit/01db9435c1e68941c64e6f1d8ab77244df75741f))
* **broadcasts:** поддержать icon_custom_emoji_id у кастомных кнопок рассылки ([ff029c7](https://github.com/abubakrmuminov/belazvpn/commit/ff029c7073b5a72885e2e53283bb088995072057))
* **broadcasts:** поддержать icon_custom_emoji_id у кастомных кнопок рассылки ([c690351](https://github.com/abubakrmuminov/belazvpn/commit/c69035111c90b44fc25baf06561bebf9976c97df))
* **cabinet:** add recurrent-payments legal document ([8f4ecf2](https://github.com/abubakrmuminov/belazvpn/commit/8f4ecf2403b4e3e63087b5d75b73078c9bd56d38))
* **cabinet:** команды бота (/start и др.) в логе действий пользователя ([fd3efd7](https://github.com/abubakrmuminov/belazvpn/commit/fd3efd714d57a62be174e674cb58c6d9fe8ad225))
* **cabinet:** нажатия кнопок бота и действия в кабинете в таймлайне активности ([2ceb615](https://github.com/abubakrmuminov/belazvpn/commit/2ceb615a3db763ac2422d6ef9fdf05341eba3592))
* **cabinet:** отправка прямого сообщения юзеру из карточки в кабинете ([c4130c1](https://github.com/abubakrmuminov/belazvpn/commit/c4130c18a6942c17127c6003a61e5ab83cbeb2b3))
...
* **cabinet:** таймлайн активности пользователя в карточке юзера ([be1f67a](https://github.com/abubakrmuminov/belazvpn/commit/be1f67adc01d77a06782097f14f8f3f46508fe7b))
...
* **coupons:** cabinet API для купонов — партии, экспорт ссылок, погашение ([605c024](https://github.com/abubakrmuminov/belazvpn/commit/605c024bc43728420ac2ab970f6389be1ca2bf91))
...
* **coupons:** партии одноразовых купонов на подписку для оптовой продажи ([8a5cfaf](https://github.com/abubakrmuminov/belazvpn/commit/8a5cfaf15a7d62b40791e61cf09e68b1bb3a43ec))
...
* **email:** deliver winback + lifecycle notifications to email-only users ([491f61f](https://github.com/abubakrmuminov/belazvpn/commit/491f61ffb1b44737f9ce60511adc0b57493deea2))
* **email:** email templates for all Remnawave WEBHOOK_* notifications ([a14389f](https://github.com/abubakrmuminov/belazvpn/commit/a14389f8f80a33c14fd18b6a4c4b1e70aac641a1))
* **email:** recurrent autopay success/failure to email-only users ([ba9555c](https://github.com/abubakrmuminov/belazvpn/commit/ba9555c5cad8a15e9c372da2df659f55b0011f55))
...
* **infra:** Valkey 9 вместо Redis 7 для кэша и очередей ([b0709ea](https://github.com/abubakrmuminov/belazvpn/commit/b0709ea0d5ee4a1097c2757cee59ea1e70a73ddb))
* **l10n:** локализовать флоу покупки/продления/смены тарифа ([0951c70](https://github.com/abubakrmuminov/belazvpn/commit/0951c708ae7168e9802a22a7a7954f566865ffc9))
...
* **menu:** rich-главное меню на Bot API 10.1 с фоллбеком на классику ([20c129e](https://github.com/abubakrmuminov/belazvpn/commit/20c129ea7e55e13555e4d1aa28a8f0825f1c303f))
* **menu:** rich-меню v2 — продление из кабинета, расход, логотип, эффект 🎉 ([242ed40](https://github.com/abubakrmuminov/belazvpn/commit/242ed405f22d9d5b9771baef5ac3aeb4c37c036d))
* **menu:** rich-меню v3 — кнопки «Подключить» и «Активировать триал» в таблице ([734773f](https://github.com/abubakrmuminov/belazvpn/commit/734773f3921620a2ebd1ffab76cfb92d2bdbe30b))
...
* **menu:** сворачиваемый блок подписок в rich-меню при нескольких подписках ([cfdce75](https://github.com/abubakrmuminov/belazvpn/commit/cfdce75865ecfdc35c5a939b240cdf4aa05abc4c))
...
* **nalogo:** доставка чека файлом — lknpd недоступен клиентам через VPN ([cbccaaf](https://github.com/abubakrmuminov/belazvpn/commit/cbccaaf7ac225d3ba597da1d023da994c6fb00a2))
* **nalogo:** имя и почта копируются по тапу + HTML-экранирование ([078493a](https://github.com/abubakrmuminov/belazvpn/commit/078493a9ba7440b404a55010aef20c8b5418f64d))
* **nalogo:** отправка чека пользователю + дублирование в админ-топик ([3229b5a](https://github.com/abubakrmuminov/belazvpn/commit/3229b5aaaecf8cda875a20fafdc1cb1d393d33ba))
* **nalogo:** подробный блок получателя в админ-уведомлении о чеке ([0490ffb](https://github.com/abubakrmuminov/belazvpn/commit/0490ffbed7354c6bb8e1f26d9b6c25565e94caea))
* **nalogo:** порядок полей в блоке получателя (ID, имя, username, почта) ([2ef6963](https://github.com/abubakrmuminov/belazvpn/commit/2ef6963a70b266714440cd76749e7d757126b92b))
* **payments:** интеграция платёжной системы cisPay ([392722f](https://github.com/abubakrmuminov/belazvpn/commit/392722f9bf69c459844ea0c2bf4075026f8e2bbb))
* **payments:** флаг YOOKASSA_SKIP_IP_CHECK с fail-closed проверкой платежа через API ([2ac5299](https://github.com/abubakrmuminov/belazvpn/commit/2ac52992f04a004dc61227b14171935243f31963))
...
* **promo-offers:** доставка промопредложений на email для юзеров без Telegram ([8913546](https://github.com/abubakrmuminov/belazvpn/commit/8913546c3d7c634a35c4889214c175550374ab3d))
...
* **promocodes:** комбинированные промокоды — баланс и дни подписки одним кодом ([d8f4b54](https://github.com/abubakrmuminov/belazvpn/commit/d8f4b545879e3761f5c37d523c19f7021f58875b))
...
* **remnawave:** локальная генерация happ crypt4 ссылок ([d9042c2](https://github.com/abubakrmuminov/belazvpn/commit/d9042c294256a6454f248e22f86acc5ea3e4b3b5))
* **remnawave:** локальная генерация happ crypt4 ссылок (без внешнего API) ([2ad0d57](https://github.com/abubakrmuminov/belazvpn/commit/2ad0d575552bf9cc0d9541857d9b9c9ba74f9652))
...
* WEBHOOK_SUB_EXPIRING + переводы zh/ua для webhook-писем + тесты ([38771d3](https://github.com/abubakrmuminov/belazvpn/commit/38771d3e9fdb727aa5b5a5b25e09ae4ce655fd4e))
* zh/ua для winback-писем, честный PAYMENT_RECEIVED для автосписания, тесты ([a37fad2](https://github.com/abubakrmuminov/belazvpn/commit/a37fad271a411e685e66f703dd33c5a987ed0008))
...
* **admin:** не разрывать &lt;pre&gt;-блоки при конвертации уведомлений в rich ([bf00eda](https://github.com/abubakrmuminov/belazvpn/commit/bf00eda41f1539e21331d9d3568a64f42902b5c4))
...
* **admin:** переносы строк в rich-уведомлениях + админ-уведомление о триале из диплинка ([53eda3e](https://github.com/abubakrmuminov/belazvpn/commit/53eda3e8eb3bc5b6b922beed711c34e42ba16b3a))
* **admin:** платёжные провайдеры в разделе «Платежные системы» ([a53f9ad](https://github.com/abubakrmuminov/belazvpn/commit/a53f9ad2bc13f761a51a43b36bab5ffb5356781a))
* **admin:** честное сообщение при сохранении настройки, прибитой переменной окружения ([f9dc3d4](https://github.com/abubakrmuminov/belazvpn/commit/f9dc3d4c243a8c9a68773fe08c4f634b50fa3e91))
* **admin:** честное сообщение при сохранении настройки, прибитой переменной окружения ([f63bee0](https://github.com/abubakrmuminov/belazvpn/commit/f63bee0d814f7dde9538e1d56e8600c5fb1687b3))
...
* audit support websocket mutations ([3836a5b](https://github.com/abubakrmuminov/belazvpn/commit/3836a5b9ab841ad0ee478b2e15232279e2588cba))
...
* **backup:** одиночный scheduler-цикл и BACKUP_TIME в локальной таймзоне ([#3030](https://github.com/abubakrmuminov/belazvpn/issues/3030)) ([e2bad81](https://github.com/abubakrmuminov/belazvpn/commit/e2bad816300035a970d8ef211c1b49556e6b1efd))
* **backup:** одиночный scheduler-цикл и BACKUP_TIME в локальной таймзоне ([#3030](https://github.com/abubakrmuminov/belazvpn/issues/3030)) ([b4ad4e6](https://github.com/abubakrmuminov/belazvpn/commit/b4ad4e602cdf082011625abdf6f39f62c34dd184))
...
* **bot:** тексты длиннее лимита Telegram роняли показ правил и политики ([197e096](https://github.com/abubakrmuminov/belazvpn/commit/197e09697e02f395fdee8d84f64a22b48b8443c7))
...
* **cabinet:** close refund-guard gaps — silent refund failure + extend double-benefit ([f6395a6](https://github.com/abubakrmuminov/belazvpn/commit/f6395a6fcf32648669baf9108786099889dd953d))
...
* **cabinet:** stop admin user search crashing on out-of-range numeric input ([a95b7bc](https://github.com/abubakrmuminov/belazvpn/commit/a95b7bc69e7253401c25a92e074fcb153e03e118))
* **cabinet:** возврат средств при сбое покупки тарифа после списания баланса ([#3031](https://github.com/abubakrmuminov/belazvpn/issues/3031)) ([12f6e35](https://github.com/abubakrmuminov/belazvpn/commit/12f6e356a06d43829e7f1cf8e566438406590c1e))
* **cabinet:** возврат средств при сбое покупки тарифа после списания баланса ([#3031](https://github.com/abubakrmuminov/belazvpn/issues/3031)) ([c5ac200](https://github.com/abubakrmuminov/belazvpn/commit/c5ac200c1697af7916e72ae3bbef047f7195ae0a))
...
* **campaign:** MissingGreenlet при начислении бонуса кампании на регистрации ([6ec45f6](https://github.com/abubakrmuminov/belazvpn/commit/6ec45f690f370b97c79615f914e3e6b9d8f87109))
...
* **coupons:** закрыть double-tap на подтверждении партии и двойной answer в экспорте ([8947a73](https://github.com/abubakrmuminov/belazvpn/commit/8947a73f9962366ed10ba8244b36c01cc93d4712))
* **db:** add migration for recurrent_payments table (missing on existing installs) ([1ce9430](https://github.com/abubakrmuminov/belazvpn/commit/1ce94306b8f624c3de35448642cd8dea0f486c66))
* **email:** use notify_autopay_success wrapper so email shows the new expiry date ([973cc90](https://github.com/abubakrmuminov/belazvpn/commit/973cc90640cd9208487fe23c564d403396d0d9a0))
...
* **email:** не тащить CSS/JS в text/plain версию письма ([#2974](https://github.com/abubakrmuminov/belazvpn/issues/2974)) ([7b9b7f1](https://github.com/abubakrmuminov/belazvpn/commit/7b9b7f1c36ef11502feca3c6405303084c2369a7))
* **email:** не тащить CSS/JS в text/plain версию письма ([#2974](https://github.com/abubakrmuminov/belazvpn/issues/2974)) ([e4af7f2](https://github.com/abubakrmuminov/belazvpn/commit/e4af7f2ecd28aab15af6397f97fce48b5b426bf7))
...
* harden mobile support websocket session guards ([1dc4e9e](https://github.com/abubakrmuminov/belazvpn/commit/1dc4e9e9877cdb7a2c8e8c4c8a3761f9f1483e10))
...
* **l10n:** добавить недостающие ключи t() во все локали и защитить тестом ([3a0e54b](https://github.com/abubakrmuminov/belazvpn/commit/3a0e54bc4b9880726ae0ce20ec5e4d617ba7f44e))
...
* **maintenance:** не разворачивать traceback для ожидаемых отказов Telegram ([27b02e4](https://github.com/abubakrmuminov/belazvpn/commit/27b02e4f363914e8b0982d13c4a213ab4c1982d5))
...
* **menu:** кнопки таблицы в видимую строку + эфемерное подтверждение триала ([f7809b7](https://github.com/abubakrmuminov/belazvpn/commit/f7809b7b323ecbb493eae9f1f2b8f440c5869367))
* **menu:** не разворачивать traceback для ожидаемых ошибок rich-меню ([1ca972d](https://github.com/abubakrmuminov/belazvpn/commit/1ca972d6d6f01b18d474d9363eaae86294c797af))
* **menu:** не строить tg-time для дат вне 32-битного unix-диапазона Telegram ([e3dfcf7](https://github.com/abubakrmuminov/belazvpn/commit/e3dfcf726b08acc7ae1a63aa4efddb42f7aee752))
* **menu:** не строить tg-time для дат вне 32-битного unix-диапазона Telegram ([c0b932e](https://github.com/abubakrmuminov/belazvpn/commit/c0b932e71eeb4cfa6a31702f59d215ea934f35d6))
...
* **monitoring:** поддержать плейсхолдер {days} в SUBSCRIPTION_EXPIRING_PAID ([d445dfa](https://github.com/abubakrmuminov/belazvpn/commit/d445dfaf5ba72617711cdc6e2224f83b3c787a95))
* **monitoring:** поддержать плейсхолдер {days} в SUBSCRIPTION_EXPIRING_PAID ([bc51a06](https://github.com/abubakrmuminov/belazvpn/commit/bc51a0624739b322c3e67d646ecfd3526385bb80))
...
* **nalogo:** print_url строил ссылку на чек без /v1 ([a472d11](https://github.com/abubakrmuminov/belazvpn/commit/a472d11279f6fba23d7bdc771ced30a747aaa31f))
...
* **nalogo:** дочитывать печатную форму чека до конца ([7dcd18e](https://github.com/abubakrmuminov/belazvpn/commit/7dcd18ec8a27a855b644ea1eab7d0b9989204f57))
* **nalogo:** не терять чек, если Telegram отверг файл, и не слать HTML как чек ([abde46c](https://github.com/abubakrmuminov/belazvpn/commit/abde46cbe501c5d2712f2aaf2b2f61fc09085a5d))
* **nalogo:** ссылка на чек — добавлен /v1 (баг библиотечного print_url) ([a547f5c](https://github.com/abubakrmuminov/belazvpn/commit/a547f5cb5f6f83aa5f73ad24fec9df0b307f5a4d))
...
* **notifications:** email-юзерам уведомления в flow "пополнение -&gt; автопокупка" ([#2952](https://github.com/abubakrmuminov/belazvpn/issues/2952)) ([d527ce5](https://github.com/abubakrmuminov/belazvpn/commit/d527ce57c5a29d314c8c59b94a670c8def0fe510))
* **notifications:** email-юзерам уведомления в flow «пополнение → автопокупка» ([#2952](https://github.com/abubakrmuminov/belazvpn/issues/2952)) ([083289d](https://github.com/abubakrmuminov/belazvpn/commit/083289d7b1b9f83d6c1b5bf42bd17ee6d3218112))
* **notifications:** label trial→paid auto-purchase as activation, not renewal; test real templates ([551236e](https://github.com/abubakrmuminov/belazvpn/commit/551236e1451a4f47530253d309b62f18b89f801a))
...
* **platega:** поддержка v2 API - поле url и настраиваемая версия эндпоинта ([#2934](https://github.com/abubakrmuminov/belazvpn/issues/2934)) ([681a1d2](https://github.com/abubakrmuminov/belazvpn/commit/681a1d2fc38f5a17e5f6cb60964517df015462ba))
* **platega:** поддержка v2 API — поле url и настраиваемая версия эндпоинта ([#2934](https://github.com/abubakrmuminov/belazvpn/issues/2934)) ([7ff3b40](https://github.com/abubakrmuminov/belazvpn/commit/7ff3b402c4423faecc8ca462208a352121a60d83))
...
* refresh admin user-messages list without a hand-built callback ([3323b7f](https://github.com/abubakrmuminov/belazvpn/commit/3323b7fa699f12ce8980dc090f2d09b42e7f0f43))
* reload daily subscription with user+tariff after commit (MissingGreenlet) ([c0bfea7](https://github.com/abubakrmuminov/belazvpn/commit/c0bfea720693f6d59d611c1895c224dae1158e21))
...
* **remnawave:** кэш локальных happ crypt4 ссылок (стабильность между вызовами) ([0b54d59](https://github.com/abubakrmuminov/belazvpn/commit/0b54d59d5a8741b393524cb00e13de0b84118a7c))
...
* **remnawave:** пересоздавать удалённого из панели юзера при живой подписке ([9f31282](https://github.com/abubakrmuminov/belazvpn/commit/9f31282785c34d2f5a840c9b429360bba232358b))
...
* restore happ crypto links on Remnawave 2.8.0 via official Happ API ([31711d4](https://github.com/abubakrmuminov/belazvpn/commit/31711d44f74f9c01a6daea510c691dc7ae6e7b57))
...
* **subscription:** block prorated instant switch from free tariffs ([6aca902](https://github.com/abubakrmuminov/belazvpn/commit/6aca9024cf6d3d0a79cd329d188a4a3d66251c80))
* **subscription:** block prorated instant switch from free tariffs ([6ef7d0e](https://github.com/abubakrmuminov/belazvpn/commit/6ef7d0e4146f18b7afe2a6701b2c74388ff2a0b6))
...
* **subscription:** make TARIFF_SWITCH_RESET_FREE_DAYS actually reset the free/trial period ([73050c3](https://github.com/abubakrmuminov/belazvpn/commit/73050c3787d26b74079806b4f1fe104d87798029))
* **subscription:** NameError при продлении тарифа после списания денег ([82b7131](https://github.com/abubakrmuminov/belazvpn/commit/82b7131154e93f2bc4719cae4c64c171648e0f96))
* **subscription:** конверсия живого триала при покупке тарифа в мульти-режиме ([76aa67c](https://github.com/abubakrmuminov/belazvpn/commit/76aa67cb5493e681515799ef3405618fa4c1c1c2))
...
* **support-ws:** dedup idempotent retries, canonical reply status, telegram parity, send lock ([0c58a49](https://github.com/abubakrmuminov/belazvpn/commit/0c58a498ea591783d45a9c808910b72a2bed356f))
...
* **tickets:** писать id реального админа в ticket_messages.user_id ([#3029](https://github.com/abubakrmuminov/belazvpn/issues/3029)) ([eb326db](https://github.com/abubakrmuminov/belazvpn/commit/eb326db4f09029e2e6f4e5ac6ecc1f60d1ab5746))
* **tickets:** писать id реального админа в ticket_messages.user_id ([#3029](https://github.com/abubakrmuminov/belazvpn/issues/3029)) ([fc92019](https://github.com/abubakrmuminov/belazvpn/commit/fc92019c10c2c6712a4948539aaa24d2d5809b3e))
...
* **webhooks:** bound payment-callback concurrency to prevent DB pool exhaustion ([f72effc](https://github.com/abubakrmuminov/belazvpn/commit/f72effce7548b9a3419ee7002f0acebeff714762))
...
* восстановление затёртых dev-фич и фиксы grace-подсистемы (PR [#3075](https://github.com/abubakrmuminov/belazvpn/issues/3075)) ([35206d7](https://github.com/abubakrmuminov/belazvpn/commit/35206d7ba0bd9a2f5c17a42f49f3e919112d6773))
...
* **coupons:** единый build_coupon_deeplink вместо трёх копий формата ссылки ([bc5dfcf](https://github.com/abubakrmuminov/belazvpn/commit/bc5dfcf677fb4e167d5ce48b9cbf1e08f63a0d40))
...
* **tests:** valkey-образ содержит redis-* как compat-симлинки — уточнение докстринга ([0a435c7](https://github.com/abubakrmuminov/belazvpn/commit/0a435c79fbcbcfddac35256017a1cd7444d661b0))
* **valkey:** точные формулировки лицензий (7.4 = RSALv2/SSPLv1; AGPLv3 только с Redis 8) и симлинков в тестах ([23183cb](https://github.com/abubakrmuminov/belazvpn/commit/23183cbb363203662a4c4c8b0da4c06075a05349))
* актуализация комментария get_receipt_print_url после фикса библиотеки ([#3083](https://github.com/abubakrmuminov/belazvpn/issues/3083)) ([3b4f37f](https://github.com/abubakrmuminov/belazvpn/commit/3b4f37fa247dcbe53c3545a8296662df0400dc38))
