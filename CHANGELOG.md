...
## [5.0.0](https://github.com/abubakrmuminov/belazvpn/compare/v4.7.1...v5.0.0) (2026-09-09)
...
* activate gift codes in bot ([81c5591](https://github.com/abubakrmuminov/belazvpn/commit/81c5591ae3c6390d9351c25c36f55edc9c5091ed))
* add idempotent gift balance service ([6e87564](https://github.com/abubakrmuminov/belazvpn/commit/6e875643b23a74730b06fbfcb65f5398f9bcfdad))
* add native gift selection flow ([8c90b76](https://github.com/abubakrmuminov/belazvpn/commit/8c90b760dd6e7a97f5007b744e95ff204889521f))
* add recoverable gift history ([1128018](https://github.com/abubakrmuminov/belazvpn/commit/1128018dd205811a0a441d68af7a19f604de233a))
* add sender gift history service ([ef8cdb5](https://github.com/abubakrmuminov/belazvpn/commit/ef8cdb51df049a25358d90ed3ad527abcc7d4639))
* add typed ban notification templates ([30878b1](https://github.com/abubakrmuminov/belazvpn/commit/30878b156ac1efe42338c28fbdfead8bcd68feb6))
* **admin:** add Bedolaga-first User Detail contracts ([57e2794](https://github.com/abubakrmuminov/belazvpn/commit/57e2794f55ba8cff918ff5c622bb6bbf9df9afb5))
* **admin:** resolve users by subscription remnawave uuid ([101f0fc](https://github.com/abubakrmuminov/belazvpn/commit/101f0fc578f71bdce45e3c3259e199018872c7e9))
* **auth:** add system-wide invite-only registration ([b639273](https://github.com/abubakrmuminov/belazvpn/commit/b639273dfd1783f6aac09b16241b1a6efee726eb))
* **auth:** добавить системный режим регистрации только по приглашениям ([dce9336](https://github.com/abubakrmuminov/belazvpn/commit/dce933662eb3004fbe532f0faba5a2d30e56d4a2))
* **cabinet-auth:** письмо подтверждения можно запросить снова до входа ([423bbf7](https://github.com/abubakrmuminov/belazvpn/commit/423bbf7d187dcee9ebfd922daf01d7a770577504))
* **cabinet:** GET /branding/favicon — иконка вкладки, которую видит Safari ([46a7590](https://github.com/abubakrmuminov/belazvpn/commit/46a7590c34ba778efbbcfcb4c1a617bc1a175c40))
* **cabinet:** дроссель регистрации по email на час и сутки, свой список одноразовых доменов ([0b622ba](https://github.com/abubakrmuminov/belazvpn/commit/0b622ba5c1a29f014f19c2dedfa32a93af8ca4a8))
* **cabinet:** панельная идентичность и контракты под 3.0.0 ([2b97440](https://github.com/abubakrmuminov/belazvpn/commit/2b9744049dcfce6677e44442490202f08b31b0a9))
* **cabinet:** раздел grace-доступа в админке ([f7010f2](https://github.com/abubakrmuminov/belazvpn/commit/f7010f2538ae6038859fa3b852b90bcef1d609c3))
* **cabinet:** согласие с офертой и политикой при первой авторизации ([3b0306f](https://github.com/abubakrmuminov/belazvpn/commit/3b0306fae60ac2ad905d6c10c35402167d983902))
* **cabinet:** удаление конкретной подписки из карточки пользователя ([56a9959](https://github.com/abubakrmuminov/belazvpn/commit/56a9959d7738d6b646bcfd001b5de265a683b604))
* **cabinet:** фото профиля для шапки отдаёт бот через GET /auth/me/avatar ([17b3825](https://github.com/abubakrmuminov/belazvpn/commit/17b382532f94a4c89220124f1dde25a88b5c454f))
* **config:** TRAFFIC_EXCLUDED_USER_UUIDS переименован в _USER_IDS ([88a92f7](https://github.com/abubakrmuminov/belazvpn/commit/88a92f794267f599bba993811119cccba72fb2f7))
* **coupons:** лимит активаций на пользователя и удаление партий ([8260944](https://github.com/abubakrmuminov/belazvpn/commit/82609441ae29e24d9037ce77b8299836a6ec8844))
* **db:** числовая панельная идентичность remnawave_id ([898bcf4](https://github.com/abubakrmuminov/belazvpn/commit/898bcf49bcb829e54a02808c0af1055216d81837))
* **devices:** запрет уменьшать лимит устройств ниже включённого в тариф ([8aafb64](https://github.com/abubakrmuminov/belazvpn/commit/8aafb648b97830aabf885eda47954f92fe888a6f))
* **email:** {unsubscribe_url} доступен в общей обёртке писем ([10ae6c7](https://github.com/abubakrmuminov/belazvpn/commit/10ae6c78317e095f36bbb36a700ff4c60e832a4d))
* **email:** выключатель писем по типу в редакторе шаблонов ([4a730da](https://github.com/abubakrmuminov/belazvpn/commit/4a730dac19733a3bf9a8eae62851a6d7f47a7f2d))
* **email:** заголовок Reply-To (SMTP_REPLY_TO) ([6a26e39](https://github.com/abubakrmuminov/belazvpn/commit/6a26e397d3b2366d5bc24a48af3b2c6c49f5dba5))
* **email:** кастомизируется всё — рассылки, получатель в обёртке, имя файла чека ([768a6cc](https://github.com/abubakrmuminov/belazvpn/commit/768a6cc2fc3caf08265b0040a45e608656ebc722))
* **email:** общая обёртка писем редактируется в админке ([0ed886a](https://github.com/abubakrmuminov/belazvpn/commit/0ed886ad85aa8667ba4709aa3f773d3a061a1ed1))
* **email:** отписка от маркетинговых писем (one-click, RFC 8058) ([4825527](https://github.com/abubakrmuminov/belazvpn/commit/482552705400a44e8afb83904a310875fa4261fb))
* **email:** очередь повторной отправки писем ([0042731](https://github.com/abubakrmuminov/belazvpn/commit/0042731c1ab561c4e6624124ee10bf9bba82df16))
* **email:** очередь повторной отправки писем ([5929c18](https://github.com/abubakrmuminov/belazvpn/commit/5929c18a380c56550778808dafa43834b4f05647))
* **errors:** журнал системных ошибок со статусом доставки ([e702700](https://github.com/abubakrmuminov/belazvpn/commit/e70270021051dec1eb05643e1df211bf6ec1aab3))
* **errors:** журнал системных ошибок со статусом доставки ([cfad920](https://github.com/abubakrmuminov/belazvpn/commit/cfad920b1e9c12eb4fe338e770c424c675297858))
* expose canonical gifts in cabinet api ([5bf8a9a](https://github.com/abubakrmuminov/belazvpn/commit/5bf8a9aa1b2b78cda07951d395c5e3a8cd347013))
* **gift:** QR-код подарка и готовый текст для отправки ([810ed7f](https://github.com/abubakrmuminov/belazvpn/commit/810ed7ffd10d833a3df867609ccf08760587b7d6))
* **gift:** добавить дарение подписок между ботом и кабинетом ([8d71f77](https://github.com/abubakrmuminov/belazvpn/commit/8d71f774f2ce68bd5cbca43808824c1f93fb4f4b))
* **grace:** allow configuring external squad via GRACE_ACCESS_EXTERNAL_SQUAD_UUID ([e2d5f3e](https://github.com/abubakrmuminov/belazvpn/commit/e2d5f3e0d0ba012552b53370108388a9bad37062))
* **grace:** упростить квоту трафика и правила доступности ([2e40235](https://github.com/abubakrmuminov/belazvpn/commit/2e40235e60677550ca975904c381414d2ae8a4d0))
* **landing:** засчитывать гостевую покупку в рекламную кампанию ([1c46702](https://github.com/abubakrmuminov/belazvpn/commit/1c46702cdf18c437c71de6d0129a65cdfa0f4794))
* **landing:** засчитывать гостевые покупки в рекламные кампании ([7203ca9](https://github.com/abubakrmuminov/belazvpn/commit/7203ca9f88cf5f37d82cdb0476f417799d621a6e))
* **landing:** сохранять слаг рекламной кампании в гостевой покупке ([4a81705](https://github.com/abubakrmuminov/belazvpn/commit/4a81705d277c5e2fd92da47907e04cf8b4abb590))
* **lava:** кабинет-эндпоинты автопродления Lava ([0dea218](https://github.com/abubakrmuminov/belazvpn/commit/0dea218298be16111e61572d9d450154e3f476a3))
* **lava:** паритет покупки привязкой, уведомления, сверка суммы ([de3518b](https://github.com/abubakrmuminov/belazvpn/commit/de3518b763fb1a49d38629472969115a18014134))
* **lava:** рекуррентные подписки Lava по образцу Platega ([9d1772b](https://github.com/abubakrmuminov/belazvpn/commit/9d1772bcfe26a3ef75bb8a47e7e33180d1fa3cba))
* **menu:** кнопка «Меню» Telegram открывает веб-кабинет (WebApp) ([c7e2087](https://github.com/abubakrmuminov/belazvpn/commit/c7e208750efd6a2cb43c6c6607cf84d3109f595c))
* **mulenpay:** передавать контакт клиента в поле client ([b4a062a](https://github.com/abubakrmuminov/belazvpn/commit/b4a062ab9395614102d8d0fb8177d230a5ac12fd))
* **nalogo:** доставка чека на почту, когда Telegram недоступен ([3c047ed](https://github.com/abubakrmuminov/belazvpn/commit/3c047edb0b884f6bf5ade8e9bb3bc9c1af382609))
* **payments:** интеграция ParityPay ([f1c0ad7](https://github.com/abubakrmuminov/belazvpn/commit/f1c0ad7c0f191eb6ecace3cae9b6c1644d93aff1))
* **payments:** интеграция TabPay ([068b816](https://github.com/abubakrmuminov/belazvpn/commit/068b8168100210f95744ee67cc853543d3023bba))
* **platega:** CRUD рекуррентных подписок ([9cf2aa3](https://github.com/abubakrmuminov/belazvpn/commit/9cf2aa3a546e639369077dfb30ab65bbcb2e5c89))
* **platega:** WS-события sbp_recurring.* для кабинета ([f34431a](https://github.com/abubakrmuminov/belazvpn/commit/f34431a46b00dc2fc1169f9ede4a43aee6405ac9))
* **platega:** админка кабинета — статус и отмена СБП-автооплаты ([135771e](https://github.com/abubakrmuminov/belazvpn/commit/135771e02e05761b72961a97d7364e72b6706177))
* **platega:** бот-флоу автопродления через СБП ([a69d233](https://github.com/abubakrmuminov/belazvpn/commit/a69d233886874883b25b89f6d3230db41a3b61f4))
* **platega:** ветка подписочных коллбеков в /platega-webhook ([9d13c4e](https://github.com/abubakrmuminov/belazvpn/commit/9d13c4ec5069e5571212ad967028d8ccaf29e998))
* **platega:** гейт PLATEGA_RECURRENT_ENABLED ([23ba645](https://github.com/abubakrmuminov/belazvpn/commit/23ba6455fd43c69075fa8540b0f86f0358c7ac3b))
* **platega:** кабинетные эндпоинты СБП-автопродления (юзер) ([19862a2](https://github.com/abubakrmuminov/belazvpn/commit/19862a298e6233587de9351abf862f3040dfae6e))
* **platega:** методы подписок в PlategaService (create/get/list/cancel) ([27c8fac](https://github.com/abubakrmuminov/belazvpn/commit/27c8fac35a5e2edf88db0723520cc2323cd0118d))
* **platega:** модель platega_subscriptions + миграция ([5c9580a](https://github.com/abubakrmuminov/belazvpn/commit/5c9580a8e0b2ce06199419bae93b648a182a7187))
* **platega:** обработчик коллбеков подписки (продление, идемпотентность, статусы) ([5a33a9e](https://github.com/abubakrmuminov/belazvpn/commit/5a33a9e703137240aa3fc75173840bc861420ad8))
* **platega:** отмена СБП-автооплаты при удалении/отзыве подписки ([2593424](https://github.com/abubakrmuminov/belazvpn/commit/2593424901a1653a7ea264eff43475bfea6e9694))
* **platega:** отмена СБП-подписки + best-effort хелпер по подписке ([4763cbe](https://github.com/abubakrmuminov/belazvpn/commit/4763cbe1da6e8d41a15f4880ff36efa436246219))
* **platega:** реконсилятор СБП-подписок в monitoring-цикле ([1cf5212](https://github.com/abubakrmuminov/belazvpn/commit/1cf5212e085b0267179b3663366e4eab7f9761f0))
* **platega:** СБП-оформление подписки — альтернатива оплате с баланса ([43d81c8](https://github.com/abubakrmuminov/belazvpn/commit/43d81c86c3d2afe7695af18ad72d072e13229393))
* **platega:** создание СБП-подписки + выключение balance-autopay ([e701cad](https://github.com/abubakrmuminov/belazvpn/commit/e701cad459a1a3204a5546d829c3b5accb0d1b8f))
* **platega:** чистая логика каденса рекуррентных СБП-подписок ([8200847](https://github.com/abubakrmuminov/belazvpn/commit/8200847d86de32989df5490a4581a1fffd7c8029))
* **promo-offers:** охват сегментов и прогресс доставки промопредложений ([5e4548b](https://github.com/abubakrmuminov/belazvpn/commit/5e4548b3d3dcee63db42f9b6a57a8daea274a290))
* **promocodes:** трафик в наборе бонусов промокода ([93f5bff](https://github.com/abubakrmuminov/belazvpn/commit/93f5bff49691847284e8d8bb12650bffaef92084))
* purchase and share gifts from balance ([7496ed5](https://github.com/abubakrmuminov/belazvpn/commit/7496ed5143d34197942340bcd777dca1fa127c20))
* **quick-amounts:** возможность отключить кнопки быстрых сумм пополнения ([b1f9be6](https://github.com/abubakrmuminov/belazvpn/commit/b1f9be6da15a25c95de1a4f729a1e8f9b844a93c))
* **reachability:** вердикт лега и соответствие ожиданию по назначению хоста ([a59845e](https://github.com/abubakrmuminov/belazvpn/commit/a59845e108115c832278ac6c9889d11bc8958267))
* **reachability:** драйвер пачки — не более трёх проб одновременно, возобновление обходчиком, отмена ([41908ff](https://github.com/abubakrmuminov/belazvpn/commit/41908ff60cbe67115387b689ae782f48b0bb2b12))
* **reachability:** запуск и остановка обходчика задач в main ([f3a15ec](https://github.com/abubakrmuminov/belazvpn/commit/f3a15eca73b02d29380a9256c718afd281e4a000))
* **reachability:** каталог симок, селекторы и расчёт пропусков ([1e3626b](https://github.com/abubakrmuminov/belazvpn/commit/1e3626bd237336a1cdeec191c9fa84c0ea838127))
* **reachability:** клиент API — остановка идущей пробы тем же Idempotency-Key ([0518a29](https://github.com/abubakrmuminov/belazvpn/commit/0518a290aae152ce9bb0ebfd0f61330f4c50ad15))
* **reachability:** клиент bschekbot API с разбором конверта ошибок и фикстуры живых ответов ([7c3ee05](https://github.com/abubakrmuminov/belazvpn/commit/7c3ee05d9c502cfc0df23c377b0c9ace6c5aadcd))
* **reachability:** настройки BSCHEK_*, категория реестра и права раздела ([188d95a](https://github.com/abubakrmuminov/belazvpn/commit/188d95ada0827ad0ab160283be360d57b9b395ea))
* **reachability:** нормализация целей, назначение хоста и подсети /24 ([ad6856a](https://github.com/abubakrmuminov/belazvpn/commit/ad6856a500fbfcc485f06e46ea2ac6e31760f61c))
* **reachability:** остановка идущей пробы — платим только за проверенные симки ([f26781d](https://github.com/abubakrmuminov/belazvpn/commit/f26781d97d337dfd55a8e5bee8d3c90fae3ad13a))
* **reachability:** пачка проверок — модель, миграция 0116, CRUD ([1b02ff8](https://github.com/abubakrmuminov/belazvpn/commit/1b02ff80c2ca74ade32eb0bdbc133cbcff1d2833))
* **reachability:** правила пачки — нарезка по 10 целей, оценка времени, статус из задач ([63c34ef](https://github.com/abubakrmuminov/belazvpn/commit/63c34ef536ddb85226fe31b8334496cacac30b7e))
* **reachability:** прогресс идущего скана в задаче ([7de7119](https://github.com/abubakrmuminov/belazvpn/commit/7de71198fc9b0cca264c14c5bf1f9d2b4b3bb787))
* **reachability:** разбор ссылок vless/vmess/trojan/ss/hysteria2 ([20474f7](https://github.com/abubakrmuminov/belazvpn/commit/20474f70a72e514ece21923e56b266960626142a))
* **reachability:** разрешение целей из хостов, нод, подписок и ввода ([444d04a](https://github.com/abubakrmuminov/belazvpn/commit/444d04ac064a41e4d1d9e59f3ec565dc64d0b66b))
* **reachability:** раскладка ответов в леги и слияние пропусков ([eacd1c0](https://github.com/abubakrmuminov/belazvpn/commit/eacd1c006621875221b9eaa96826190c78ddd009))
* **reachability:** роуты и схемы /admin/reachability для кабинета ([68d8f60](https://github.com/abubakrmuminov/belazvpn/commit/68d8f60638f9d037e7a02ad4f47825d4cd963154))
* **reachability:** ручки пачки проверок для кабинета — превью, запуск, статус, отмена ([4bd07dc](https://github.com/abubakrmuminov/belazvpn/commit/4bd07dc81f0edd734b6439075e321dc1a9fc9665))
* **reachability:** сервис задач — фон, повтор ключом, опрос, отмена, обходчик ([f6eab38](https://github.com/abubakrmuminov/belazvpn/commit/f6eab38e159fbc2b5d3c004bca7fea1ef290b7c7))
* **reachability:** сервис пачки — превью суммой по чашкам, запуск, отмена ([6e82e79](https://github.com/abubakrmuminov/belazvpn/commit/6e82e799270927b700e2da296d745acc33980a18))
* **reachability:** таблицы задач, легов и предпочтений целей с CRUD и сводкой ([e107364](https://github.com/abubakrmuminov/belazvpn/commit/e107364394211636f9c401d08970cfa8c612cde4))
* **reachability:** тела запросов и фасад сервиса — статус, preview, запуск, сводка ([d62cf8a](https://github.com/abubakrmuminov/belazvpn/commit/d62cf8af1e98223dd546d0cfc2c8dee015a211a9))
* **reachability:** цены — кредиты в копейки, оценка VLESS, потолок задачи ([f2cc545](https://github.com/abubakrmuminov/belazvpn/commit/f2cc545980aaa3e39b01b4962ce7c2f325250924))
* **reachability:** частичный результат идущей пробы в задаче — кабинет видит «проверяем…» по симкам ([ea5b9b6](https://github.com/abubakrmuminov/belazvpn/commit/ea5b9b6b4681a4718b348dc047f4cdbc279d3d8a))
* **reachability:** шлюз платных вызовов с интервалом и повтором 429 ([aa95a7d](https://github.com/abubakrmuminov/belazvpn/commit/aa95a7d483b472ca3a4abd27c2c26590224b949f))
* **referral:** a level is unlocked by referral count, and says so ([ea3b95e](https://github.com/abubakrmuminov/belazvpn/commit/ea3b95e29b4d79ac7f2a78c16deb3e898f7ead27))
* **referral:** admin editor for reward levels ([0e3b051](https://github.com/abubakrmuminov/belazvpn/commit/0e3b051cfb967eadc776da274bc7b71b11a9846a))
* **referral:** expose levels and day rewards through the cabinet API ([fbd20bb](https://github.com/abubakrmuminov/belazvpn/commit/fbd20bb45fd55d31fe85b9912e7957eabf40f6f7))
* **referral:** multi-level rewards in money and/or subscription days ([c252439](https://github.com/abubakrmuminov/belazvpn/commit/c252439a9e711243c06d31e3a5ad283151bc4f96))
* **referral:** set the chain depth from the level editor, up to ten levels ([5b14a65](https://github.com/abubakrmuminov/belazvpn/commit/5b14a6563c1c8de8d8f6c43274b17e20044efd67))
* **referral:** show subscription-day rewards across statistics and the user screen ([0fb08fa](https://github.com/abubakrmuminov/belazvpn/commit/0fb08fabae14c1a710f72110cab4efcd37d0a72c))
* **referral:** выбор награды двоичный — деньги или дни ([f733524](https://github.com/abubakrmuminov/belazvpn/commit/f7335241ab5ff1bbc774824923287eecd1abb10a))
* **referral:** называть ступени уровнями и отдавать их кабинету по частям ([61c8d66](https://github.com/abubakrmuminov/belazvpn/commit/61c8d66937cffae8b20905c74f5efa62e5647695))
* **referral:** показывать суммы сторон и спрашивать подписку только под дни ([b7dc6d7](https://github.com/abubakrmuminov/belazvpn/commit/b7dc6d7c779331fbe4b28a8826f2dc7581b5855e))
* **referral:** пользователь выбирает вид награды и подписку для дней ([85c17b6](https://github.com/abubakrmuminov/belazvpn/commit/85c17b6f624a92b2288e38877379aa248a6f264c))
* **referral:** режим рангов — один уровень за число рефералов ([dedf9fb](https://github.com/abubakrmuminov/belazvpn/commit/dedf9fbacb0fb5ca63e2b8a687b513022e48a561))
* **remnawave:** бэкфил панельной идентичности ([b97e5f6](https://github.com/abubakrmuminov/belazvpn/commit/b97e5f6bbfa7bf792b06f4ac181e214cec5da96c))
* **remnawave:** клиент API под 3.0.0 ([c763514](https://github.com/abubakrmuminov/belazvpn/commit/c763514324c45aff3193631cc4c344873c3ebc55))
* **remnawave:** проксировать GeoCheck ноды из панели 3.3.0 в кабинет ([134d8e4](https://github.com/abubakrmuminov/belazvpn/commit/134d8e4ef828d138bc74a4608af9ee64c15e6e98))
* **remnawave:** сервисный слой на числовую идентичность ([6da10bc](https://github.com/abubakrmuminov/belazvpn/commit/6da10bcc94e2dbf37e7d646d48e3a3a018a60c4d))
* **remnawave:** транслитерация кириллицы в username пользователя ([35383c2](https://github.com/abubakrmuminov/belazvpn/commit/35383c206aa0d2bb8e86c3745a96ed8f80666e4a)), closes [#1659](https://github.com/abubakrmuminov/belazvpn/issues/1659)
* **remnawave:** хендлеры, миддлвари и Web API под 3.0.0 ([c897d38](https://github.com/abubakrmuminov/belazvpn/commit/c897d383ceb0177babc5f38ecca368899228bc0d))
* **remnawave:** чтение хостов панели (GET /api/hosts) ([d8f26ad](https://github.com/abubakrmuminov/belazvpn/commit/d8f26ad897758097d1da343356e4402b054e6c4f))
* resume gift checkout after balance topup ([3cf405b](https://github.com/abubakrmuminov/belazvpn/commit/3cf405b483ea947a77f2a27667171ce6c47cc358))
* **rich:** настройка вывода кнопок внутри полотна rich-сообщения (Bot API 10.3) ([fbe3594](https://github.com/abubakrmuminov/belazvpn/commit/fbe3594964c6c606eacac8798d1d0fb3f5457b6c))
* **rich:** пользовательские уведомления rich-сообщением с кнопками внутри ([497064e](https://github.com/abubakrmuminov/belazvpn/commit/497064eaa1652c6c182c22ce629fe438af6f71bc))
* **rich:** уведомления в стиле rich-меню и охват рассылок ([01d8f2c](https://github.com/abubakrmuminov/belazvpn/commit/01d8f2cf2691f3283480fbc43f5aa635140cd1f5))
* **rich:** уведомления мониторинга тоже rich — логотип не теряется ([9ebc17d](https://github.com/abubakrmuminov/belazvpn/commit/9ebc17dd8b4a08d278684cd1e0c7780073a47b67))
* show payment methods directly on extend insufficient-balance screen ([45f81a8](https://github.com/abubakrmuminov/belazvpn/commit/45f81a89f3983441e391ebe699f0dfc34ce5bbb4))
* show payment methods directly on extend insufficient-balance screen ([00c66cf](https://github.com/abubakrmuminov/belazvpn/commit/00c66cfb71743dfd2beb34f3a205b40a8f7c9331))
* skip tariff selection screen when only one tariff is available ([5c74099](https://github.com/abubakrmuminov/belazvpn/commit/5c7409940cf975ea4748519cf4d54bb265702209))
* skip tariff selection screen when only one tariff is available ([935dbe3](https://github.com/abubakrmuminov/belazvpn/commit/935dbe3825d48b0b97395bf10127e59954223708))
* sort user list by soonest subscription expiry ([e3713ce](https://github.com/abubakrmuminov/belazvpn/commit/e3713ce9710dfa8d3fbfc1abf10b034378fd8978))
* sort user list by soonest subscription expiry ([f69a670](https://github.com/abubakrmuminov/belazvpn/commit/f69a67014027efe0acb7779ce40371f0d5330866))
* **start:** видео в стартовом меню бота, загрузка из кабинета ([524960c](https://github.com/abubakrmuminov/belazvpn/commit/524960c3561953df2f18108b224dfef5292ff811))
* **subscription:** шифрованные ссылки INCY (incy://crypt1/) ([c87c350](https://github.com/abubakrmuminov/belazvpn/commit/c87c350c1cd9e5f5068c218c6ede35b3e0a39bde))
* **subscription:** шифрованные ссылки INCY (incy://crypt1/) ([af40973](https://github.com/abubakrmuminov/belazvpn/commit/af40973e85e41f84b2aeb32a725a0b86bd9f5959))
* **support-ws:** bridge core + message.created from ticket.message_added ([e54e1e3](https://github.com/abubakrmuminov/belazvpn/commit/e54e1e3009fa33d7b4a8b54a7fbcc23831b34009))
* **support-ws:** bridge ticket.created and ticket.status_changed mappings ([2ff76f3](https://github.com/abubakrmuminov/belazvpn/commit/2ff76f35970a766cdc5d6cb497455410874917d8))
* **support-ws:** emit ticket events from cabinet/mini-app routes for bridge ([d65d9fb](https://github.com/abubakrmuminov/belazvpn/commit/d65d9fb059d0f59e2812e43f28ca04988d138a68))
* **support-ws:** register event bridge at app startup ([8d80230](https://github.com/abubakrmuminov/belazvpn/commit/8d80230a8db50e9b3f668c172696e3ad7e462c04))
* **tariff:** expose custom traffic settings in Telegram admin ([d75cbfe](https://github.com/abubakrmuminov/belazvpn/commit/d75cbfec5820e051fc6bacee9a67514b0945b167))
* **tariffs:** один период тарифа можно отметить как самый выгодный ([ba52dee](https://github.com/abubakrmuminov/belazvpn/commit/ba52dee68baf4ede633cbf7b14a051aed607d1a6))
* **tariffs:** сам тариф тоже можно отметить как выгодный ([6b0fdfb](https://github.com/abubakrmuminov/belazvpn/commit/6b0fdfb37376df52efd34068deb03f1b7dda7b2f))
* **tariff:** прямая оплата тарифа без отдельного шага пополнения баланса ([a060575](https://github.com/abubakrmuminov/belazvpn/commit/a06057504de86285273e801bc411879b964a4a36))
* **tickets:** доставлять ответ поддержки на email юзерам без Telegram ([6403951](https://github.com/abubakrmuminov/belazvpn/commit/6403951568bdb541aa36bfa1de67766b7d4feeeb))
* **tickets:** доставлять ответ поддержки на email юзерам без Telegram ([2235eb5](https://github.com/abubakrmuminov/belazvpn/commit/2235eb5baf2f118ac09d332c84ef1de730b79542))
* unify public gift codes ([28b313c](https://github.com/abubakrmuminov/belazvpn/commit/28b313c8d8b9514a7427c63951bb7e7005a410ac))
* **webapi:** эндпоинт ручного пополнения баланса с идемпотентностью ([cd9811c](https://github.com/abubakrmuminov/belazvpn/commit/cd9811c18f679047a30c6c304ca99ab89f386cc6))


### Bug Fixes

* address final review findings for gift security and telemetry ([ad18226](https://github.com/abubakrmuminov/belazvpn/commit/ad18226faf828716b922b1df9444f6c4e2b6b754))
* **admin:** device_limit = 0 в админке тоже показывать безлимитом ([8e1b2cc](https://github.com/abubakrmuminov/belazvpn/commit/8e1b2cc9af70f3475466d6e8ed4a8c846b2ebdfb))
* **admin:** pin selected subscription panel identity ([88572ca](https://github.com/abubakrmuminov/belazvpn/commit/88572caf9b2f1c2a9f95343923277f1bb190b531))
* **admin:** prevent selected subscription UUID fallback ([0f9298c](https://github.com/abubakrmuminov/belazvpn/commit/0f9298c63b65aee767e1a869dd5045a17f82aa79))
* **admin:** validate supplied subscription ownership ([da87a8d](https://github.com/abubakrmuminov/belazvpn/commit/da87a8de143a1525188fc849f9a89caf566010ce))
* **admin:** запретить блокировку аккаунтов из ADMIN_IDS/ADMIN_EMAILS ([15613ee](https://github.com/abubakrmuminov/belazvpn/commit/15613ee34c28421ad07c2a9df8d472e01cdf9657))
* **admin:** лог при пропуске синка панели у подписки без UUID ([3d77bc2](https://github.com/abubakrmuminov/belazvpn/commit/3d77bc20a621702ec2f0f3bd4f21a1f5a4a80a9e))
* **admin:** новой подписке проставляется remnawave_id при обновлении аккаунта панели ([aafdb2f](https://github.com/abubakrmuminov/belazvpn/commit/aafdb2f22683026f98fcff6412497a9d3719cfb7))
* **admin:** отмена рекуррента Lava при сбросе выбранной подписки ([2f2006a](https://github.com/abubakrmuminov/belazvpn/commit/2f2006a5d08289ccfb3c606d0cdb702ccd369ea7))
* align BanHammer notification contract ([e84a9b0](https://github.com/abubakrmuminov/belazvpn/commit/e84a9b001a0a8d2502466a13f93e7da1d7e30c5d))
* **auth:** выровнять привязку подарка в двух путях завершения регистрации ([96ad208](https://github.com/abubakrmuminov/belazvpn/commit/96ad2084969c28250026b189b25b99ca61a33f5e))
* **auth:** закрыть находки ревью invite-only ([830c484](https://github.com/abubakrmuminov/belazvpn/commit/830c484fc89c938907c6e3345b3d2e13fb6b43ee))
* **auth:** не пускать регистрацию на алиасе уже занятого ящика ([c290a17](https://github.com/abubakrmuminov/belazvpn/commit/c290a17bf21ad4e8074a49117187282156df98b3))
* **auth:** не пускать регистрацию на алиасе уже занятого ящика ([8fcdefd](https://github.com/abubakrmuminov/belazvpn/commit/8fcdefd99896c90855000c7224514634ec1ad446))
* **auth:** починить поиск двойника по ящику на SQLite и не прятать чужой аккаунт ([b4fdc54](https://github.com/abubakrmuminov/belazvpn/commit/b4fdc54113a4728d664480a0e12a37ea568ddf9a))
* auto-purchase silently skipped after top-up due to updated_at race guard ([ad3e9cf](https://github.com/abubakrmuminov/belazvpn/commit/ad3e9cf5353e58df5d29e2fc9e34b278fc06f8b7))
* back button leads to main menu when tariff selection was skipped ([a6e5c5a](https://github.com/abubakrmuminov/belazvpn/commit/a6e5c5a227fa1c6f5d79e00d1801a66d05756771))
* **backup:** платежи восьми шлюзов не попадали в резервную копию ([6227130](https://github.com/abubakrmuminov/belazvpn/commit/6227130411f34b394cf0bf1f6157777d13940d2e))
* **balance:** быстрое пополнение отвечает на нажатие до похода к провайдеру ([7448af7](https://github.com/abubakrmuminov/belazvpn/commit/7448af743f6142e57f6f3ca2908a6ef163c42c03))
* **bans:** уважать общий выключатель уведомлений в типизированных банах ([927790f](https://github.com/abubakrmuminov/belazvpn/commit/927790fd4d674e32a4824c9778801d63bb360393))
* **bot:** поздний ответ на нажатие кнопки — предупреждение, а не отчёт об ошибке ([50c158f](https://github.com/abubakrmuminov/belazvpn/commit/50c158feeee4196b218861ce196a60349a66ee51))
* **broadcast:** отказ Telegram больше не теряется, подпись к медиа проверяется на входе ([10731de](https://github.com/abubakrmuminov/belazvpn/commit/10731de95170c1176600498269eb79f2a95388fe))
* build secure shareable gift links ([ce7dd46](https://github.com/abubakrmuminov/belazvpn/commit/ce7dd461618afdb6acdb403bc98832f996e3be5b))
* **cabinet:** 'keep' во внешнем скваде сравнивать без учёта регистра ([fbabcd0](https://github.com/abubakrmuminov/belazvpn/commit/fbabcd0f14be3df7a818019ecf6b26bf81e1b9c9))
* **cabinet:** id админа снимаем до цикла массового действия ([9fba46f](https://github.com/abubakrmuminov/belazvpn/commit/9fba46f4e4820d6aacd3a459ff2bf6bfdab1a228))
* **cabinet:** вернуть активацию гостевой покупки — эндпоинт падал NameError ([1b008dc](https://github.com/abubakrmuminov/belazvpn/commit/1b008dc90be9c023254c71ce934ff41c1e83891d))
* **cabinet:** вход через Telegram с веба для нового пользователя с гейтом согласия ([58e9050](https://github.com/abubakrmuminov/belazvpn/commit/58e9050c8d34a6ec7ae725b8706be46be1536448))
* **cabinet:** закрыть находки ревью раздела grace-доступа ([58472a3](https://github.com/abubakrmuminov/belazvpn/commit/58472a3fa740f8d19d1e8317b676471af28445c5))
* **cabinet:** настройки партнёрки и тикетов сохраняются в базу, а не в .env ([6014b92](https://github.com/abubakrmuminov/belazvpn/commit/6014b92b9d344ccc11dfb38bb9d7b1257e68cb77))
* **cabinet:** не отдавать пустую строку вместо null в /info/service ([1707660](https://github.com/abubakrmuminov/belazvpn/commit/1707660636fdf86547a891064ad9ec4f0f6bfafc))
* **cabinet:** отдавать в /info/service реальные настройки ([0ba8fa5](https://github.com/abubakrmuminov/belazvpn/commit/0ba8fa56bbf778e79b4cec52cde46dcc38d5e4a4))
* **cabinet:** отдавать в /info/service реальные настройки ([3329ec3](https://github.com/abubakrmuminov/belazvpn/commit/3329ec33cf824cc8568f09f01a709be6cba9b3aa))
* **cabinet:** причина отказа в докупке и уменьшении устройств — машинный код, а не фраза ([04fa516](https://github.com/abubakrmuminov/belazvpn/commit/04fa51637d39ab2bd1cf7c0086e0b66672670249))
* **cabinet:** радиус плитки фавикона 0,12 — Safari не подрисовывает белую подложку ([1625627](https://github.com/abubakrmuminov/belazvpn/commit/16256275222763579ca959c96346e38983a8ccc6))
* **cabinet:** удаление подписки адресует панельный аккаунт по режиму ([1feef2c](https://github.com/abubakrmuminov/belazvpn/commit/1feef2c55835de2256eb114d3814417aac23d38f))
* **cabinet:** удаление подписки в массовых действиях падало MissingGreenlet ([c99fd54](https://github.com/abubakrmuminov/belazvpn/commit/c99fd544fa822eec7190c8461a1179b984d2b915))
* **cabinet:** фавикон — PNG-монограмма без логотипа и скруглённая плитка с ним ([ed6296e](https://github.com/abubakrmuminov/belazvpn/commit/ed6296e2e937234a208bce31777ae47220e2ea9b))
* **cabinet:** флаг email-входа закрывает API, а не только кнопку ([23a5817](https://github.com/abubakrmuminov/belazvpn/commit/23a581729786c58dfaec814e407e6118e5b1e508))
* **cabinet:** флаг email-входа читать парсером редактора настроек, сквозной HTTP-тест гейта ([fdebcad](https://github.com/abubakrmuminov/belazvpn/commit/fdebcad1558ac83d4fe81cf218b5d240a10e2418))
* **channel:** не слать админам traceback на заблокировавших бота ([d91caee](https://github.com/abubakrmuminov/belazvpn/commit/d91caeeee24d6be463c5f0efb502f10e7016cac2))
* **ci:** lowercase-референс образа для Trivy-скана ([795c7be](https://github.com/abubakrmuminov/belazvpn/commit/795c7be735e6aaa61d2689d97c815346a090ae7b))
* clean up duplicate exports in subscription handlers ([0ff752c](https://github.com/abubakrmuminov/belazvpn/commit/0ff752c881f605048b11bffd89c15f0ec99bd3d2))
* **config:** закомментировать ключи grace в .env.example ([c53540f](https://github.com/abubakrmuminov/belazvpn/commit/c53540fc463503b9abf41145f4841e01863596cd))
* **docs:** справка по структуре не должна зависеть от состояния индекса ([b13ec78](https://github.com/abubakrmuminov/belazvpn/commit/b13ec781d80a777dce766a7cab87cfa70320afea))
* **email:** без настроенного SMTP очередь писем не крутит попытки и не шлёт ошибок ([9cf5a17](https://github.com/abubakrmuminov/belazvpn/commit/9cf5a17730a19ba70b0a4850a4e5f7c0b7275cb8))
* **email:** все письма с шаблоном редактируются в админке ([685cf8e](https://github.com/abubakrmuminov/belazvpn/commit/685cf8ebe3f4cc3324d6ada632250415c2740fbd))
* **email:** выключатель не глушит письмо с доступами кабинета ([4ce0a78](https://github.com/abubakrmuminov/belazvpn/commit/4ce0a7824171a61b078596ea78ebacb9c5b33c19))
* **email:** имена аннотаций помощника — под TYPE_CHECKING; тесты писем проходят в одиночку ([4c63f8d](https://github.com/abubakrmuminov/belazvpn/commit/4c63f8da8cd7ec4a7c3552fb3975aa2233add905))
* **email:** не ждать таймаут SMTP на каждом адресе рассылки ([b934713](https://github.com/abubakrmuminov/belazvpn/commit/b9347138cb9391857cf7791bd1108e0749cdc538))
* **email:** ограничить повторы сроком годности письма и не хранить тело дольше нужного ([45d4a3a](https://github.com/abubakrmuminov/belazvpn/commit/45d4a3ac4fb06f897b96b3fa3168da9602ef043f))
* **email:** отписку применяет только POST + границы токена ([091e2ee](https://github.com/abubakrmuminov/belazvpn/commit/091e2ee95fd4709f26b521bbc4a05a750a65eb65))
* **email:** старые имена плейсхолдеров продолжают работать, опечатки не сохраняются ([eb57b19](https://github.com/abubakrmuminov/belazvpn/commit/eb57b19bc18185025b82ea8cc466fc438b233b96))
* **email:** чек NaloGO и ссылка покупателю подарка — через редактор шаблонов ([189d32e](https://github.com/abubakrmuminov/belazvpn/commit/189d32eb2976017269e8a80278a6c89f05de4a5d))
* **errors:** не писать секреты в журнал, завести права, сливать очередь при остановке ([5ddd2a3](https://github.com/abubakrmuminov/belazvpn/commit/5ddd2a3872cbaf197260c4be41995e8fc1d8851d))
* **gift:** address code review findings for gift subscription feature ([e22dd8c](https://github.com/abubakrmuminov/belazvpn/commit/e22dd8ce80f4776d6f9f36230d85c81272d46cdb))
* **gift:** address combined review findings for gift features ([824b6a0](https://github.com/abubakrmuminov/belazvpn/commit/824b6a0b2ba7ea0f02ea41c404ce34fba714bd53))
* **gift:** harden purchase recovery and claim presentation ([8464299](https://github.com/abubakrmuminov/belazvpn/commit/8464299dc95659dad7cb499c43c4176e72fdc596))
* **grace:** реализовать обещанное 'keep' и починить тест внешнего сквада ([40459b7](https://github.com/abubakrmuminov/belazvpn/commit/40459b7cd6293f65d6590c7aed5f8327bfcb5d27))
* **grace:** сессия без панельного id чинится при чтении, а не живёт вечно ([5116848](https://github.com/abubakrmuminov/belazvpn/commit/51168487da3f51a256e59abe9655fcc8ebee0364))
* **grace:** согласователь грейса тоже перестал переписывать дату окончания ([664ecea](https://github.com/abubakrmuminov/belazvpn/commit/664ecea75fa9e2204bef188dd29010a411b670f5))
* harden gift purchase recovery flows ([f03fa56](https://github.com/abubakrmuminov/belazvpn/commit/f03fa56671c09aea8fccbc9366d5727c323e8f78))
* **i18n:** исправление ошибок перевода в fa/ua/zh локалях ([2cc0f36](https://github.com/abubakrmuminov/belazvpn/commit/2cc0f36dd89c68ee8499929ede93020932332c40))
* **lava:** взаимоисключение с Platega + сдвиг списания при ручном продлении ([da84ed1](https://github.com/abubakrmuminov/belazvpn/commit/da84ed101e539031db5ad8178e6d7b8e5139ce6d))
* **lava:** закрыты находки адверсариального ревью рекуррента ([94e3fcd](https://github.com/abubakrmuminov/belazvpn/commit/94e3fcd3147a31520e7cf51ce2a47ef0a95421d2))
* **lava:** имя провайдера в правой части «через …» вместо имени метода ([df92f68](https://github.com/abubakrmuminov/belazvpn/commit/df92f68fc5d5ca099071b8d6310b3d7388db503a))
* **logging:** убрать зарезервированный kwarg event= из вызовов structlog ([4d76382](https://github.com/abubakrmuminov/belazvpn/commit/4d76382b7756e956dc420ff0a7dfc6f970b48d10))
* **maintenance:** техработы включались сами после каждого перезапуска ([44c7269](https://github.com/abubakrmuminov/belazvpn/commit/44c7269c257c3defd6a12fe9275c6d0a87757c05))
* make BroadcastResponse.message_text Optional[str] ([9a23bc3](https://github.com/abubakrmuminov/belazvpn/commit/9a23bc371218c5866fedc53f219d3b3de2ec368c)), closes [#3151](https://github.com/abubakrmuminov/belazvpn/issues/3151)
* **menu:** приводить HTML страниц к разметке, которую понимает Telegram ([5ce73e3](https://github.com/abubakrmuminov/belazvpn/commit/5ce73e326e346b7cf580ad261def38d39f8e15ca))
* **migrations:** перенумеровать миграцию кампании в 0105 ([79b17f0](https://github.com/abubakrmuminov/belazvpn/commit/79b17f033d5088ae36b9aea32aae2b83ba1aafb8))
* **migrations:** развести номер миграции гостевых покупок с 0105 ([d4f529b](https://github.com/abubakrmuminov/belazvpn/commit/d4f529b70d624c209b51d37e03150a187e790597))
* **mulenpay:** слать в client только подтверждённый email и не блокировать оплату ([9ce44f9](https://github.com/abubakrmuminov/belazvpn/commit/9ce44f978a6cee4c147caf3561568bd0e10b4006))
* **nalogo:** доставлять чек покупателю после ручной пересылки из админки ([fa25d70](https://github.com/abubakrmuminov/belazvpn/commit/fa25d701a2227829f7d5ac087af77a68a31d145b))
* **nalogo:** чек по подарочной покупке — адресат покупатель, а не одаряемый ([3a0a157](https://github.com/abubakrmuminov/belazvpn/commit/3a0a157f35029c8c2e57b013147c74f33339059b))
* **notifications:** MissingGreenlet при уведомлении о регистрации по кампании ([0f1beff](https://github.com/abubakrmuminov/belazvpn/commit/0f1beff51b284bae0183bb37000b860e82b4ee4e))
* **notifications:** кнопка продления в мультитарифе вела в бота, а не в кабинет ([f0d0cec](https://github.com/abubakrmuminov/belazvpn/commit/f0d0cec1901ab853785dc082665a698a7a466e09))
* **notifications:** не отправлять отключённые уведомления пользователям ([22370a8](https://github.com/abubakrmuminov/belazvpn/commit/22370a804114e9514d28b47ca3b55635e12b07b1))
* **oauth:** per-origin redirect_uri so OAuth login works on mirror domains ([1f873f9](https://github.com/abubakrmuminov/belazvpn/commit/1f873f983476f34c6ce21ad407eb0de4756fd7fe))
* **oauth:** привязка провайдера тоже возвращается на домен запроса ([d99ab15](https://github.com/abubakrmuminov/belazvpn/commit/d99ab15c9957d5e24d4ea068e34e8b0a89632cd8))
* **payments:** дренаж фоновой обработки вебхуков при остановке ([531060e](https://github.com/abubakrmuminov/belazvpn/commit/531060e836fd25a05cfc0423cadf59f6321cd960))
* **payments:** не терять вебхуки платёжек, выключенных на момент старта ([67532db](https://github.com/abubakrmuminov/belazvpn/commit/67532dbd50c97fc5f97b450a53a0d0c72eb64bc6))
* **platega:** actionable-ошибка при отказе создания СБП-подписки ([0864a95](https://github.com/abubakrmuminov/belazvpn/commit/0864a95ec65f90cdcf60d2af9ff2265b3be51e0d))
* **platega:** side-effects после СБП-списания + защита от пустого charge Id и пропавшей подписки ([ee295c6](https://github.com/abubakrmuminov/belazvpn/commit/ee295c6a8dcd648f5c64b1aaea61fed238eee0d5))
* **platega:** аудит-фиксы СБП-автопродления — money-safety и полнота отмен ([ccc2049](https://github.com/abubakrmuminov/belazvpn/commit/ccc2049c7d15dda6779ce6f74a6b807459275a72))
* **platega:** гонка конкурентного enable (D5) и outage-vs-404 в reconciler (D4) ([8243d39](https://github.com/abubakrmuminov/belazvpn/commit/8243d3924e034e04ba83b61086a7e10a7ca02bdf))
* **platega:** идемпотентность создания СБП-подписки (не плодить дубли и двойные списания) ([132ef4e](https://github.com/abubakrmuminov/belazvpn/commit/132ef4e19f0ba1f24fd4958e88d2a9ceb65945e0))
* **platega:** распознавать camelCase-коллбеки рекуррентной СБП-подписки ([4123ee8](https://github.com/abubakrmuminov/belazvpn/commit/4123ee8268dbe24fd5dac330b1d2f9499275aa67))
* **platega:** санитайзить description подписки под 64-байтный лимит Platega ([f7a6f5b](https://github.com/abubakrmuminov/belazvpn/commit/f7a6f5b624856bed742373ea123648c58e9e2642))
* **platega:** СБП-автопродление доступно для суточных тарифов + гард на триал ([9fe42e7](https://github.com/abubakrmuminov/belazvpn/commit/9fe42e795c93cb26f75ca95e919adf983ac760c8))
* **platega:** синк панели после списания + обратное взаимоисключение + отмена на пропущенных путях удаления ([57ad9b7](https://github.com/abubakrmuminov/belazvpn/commit/57ad9b746e53d82c8641b7c0ee47eaa210993c21))
* **platega:** три P2 из ревью релизного PR [#3111](https://github.com/abubakrmuminov/belazvpn/issues/3111) ([64feac0](https://github.com/abubakrmuminov/belazvpn/commit/64feac0aa8e5da90da38797a4d834fbcb350c2e2))
* **premium_emoji:** handle aiogram Default object for parse_mode ([84d4983](https://github.com/abubakrmuminov/belazvpn/commit/84d49832bfd6f0b45ab751fa2a2a17df7cd07120))
* **pricing:** корректная цена за месяц для коротких и некратных периодов ([9b172b2](https://github.com/abubakrmuminov/belazvpn/commit/9b172b2d7af1ee33ac132a9341c9f967a47ed7a2))
* **pricing:** суточная цена в кабинете — только со скидкой группы, промокод не вкладывается дважды ([968687c](https://github.com/abubakrmuminov/belazvpn/commit/968687cecd7aa241a90cbdc721b3acf5d7025c20))
* **promo-offers:** счётчик сегмента expired — живая ветка вместо мёртвой ([d93762f](https://github.com/abubakrmuminov/belazvpn/commit/d93762ff0bcbd4834afc3f3bca858e63f53e08cd))
* **promocode:** MissingGreenlet при отказе активации — rollback экспирировал db_user хендлера ([d0c1d5d](https://github.com/abubakrmuminov/belazvpn/commit/d0c1d5dec2e828222d84d39d0e7aad83188abc5e))
* **promocodes:** код с одним трафиком не сгорает на безлимитной подписке ([7254930](https://github.com/abubakrmuminov/belazvpn/commit/72549306956a58aebff84111b8e0a84072675397))
* **promocodes:** трафик доезжает до строки, а начисление возвращает доступ ([0d70155](https://github.com/abubakrmuminov/belazvpn/commit/0d701557893e0bfd4d0d6f9797b63cfe6008df52))
* **quality:** разобрать замечания CodeQL по новому коду ([397869d](https://github.com/abubakrmuminov/belazvpn/commit/397869d72e1aa6483d5814fae2589b6a7fcaf76f))
* **quality:** разобрать замечания CodeQL по тестам писем ([8f277e0](https://github.com/abubakrmuminov/belazvpn/commit/8f277e01d25ca8f7416a8267893b715e882052f5))
* **reachability:** POST /jobs падал с MissingGreenlet — задача из CRUD отдаётся с загруженными легами ([1cb5940](https://github.com/abubakrmuminov/belazvpn/commit/1cb5940bba3e3be9ba7c4db8b78fc774733a114c))
* **reachability:** probe принимает не больше 10 целей — проверка до обращения к API ([8a1d0af](https://github.com/abubakrmuminov/belazvpn/commit/8a1d0af3417654bf00ffbf545fc0fd3d29cedd5c))
* **reachability:** SNI-хост без переменной — дефолт ads.x5.ru зашит в код ([e67ea44](https://github.com/abubakrmuminov/belazvpn/commit/e67ea441ca0e82f8425886f33836d6a12ccc7a80))
* **reachability:** без циклических импортов и с DNS только на публичные адреса — по замечаниям CodeQL ([fdb7bef](https://github.com/abubakrmuminov/belazvpn/commit/fdb7befec49968711a34d99700a8206c0a94d619))
* **reachability:** версии ядер Xray в статусе, SNI-имена только из доменов, внятная ошибка для пользователя без подписки ([ace7a6d](https://github.com/abubakrmuminov/belazvpn/commit/ace7a6df50e711ae043af3798a6030dac7260178))
* **reachability:** зависшая проба — след последнего ответа API в задаче и потолок 45 минут вместо вечного «идёт» ([4daf218](https://github.com/abubakrmuminov/belazvpn/commit/4daf2188dc723dcecbfd4b04b51e83ea1e13bdc4))
* **reachability:** ошибка зависшей пробы — словами для людей, без кода ответа API; номер запроса для поддержки ([af3decc](https://github.com/abubakrmuminov/belazvpn/commit/af3decc070dfd9b8eecd9b4f4535df18a1ec36cf))
* **reachability:** повтор пробы без результата — уровень info, это штатное ожидание провайдера ([e2e54a1](https://github.com/abubakrmuminov/belazvpn/commit/e2e54a1f68514b170b9bf384a0b6ff53b16fddc3))
* **reachability:** подписка как у клиента — JSON-формат (Happ/HWID), балансировщик «АВТО» по outbound, HWID-повтор ([a26fafe](https://github.com/abubakrmuminov/belazvpn/commit/a26fafed58add66cde15a6512fdf178f5074b46c))
* **reachability:** ссылки подписки через рабочие ручки панели, SNI-хост по умолчанию и свои имена, разбор поля «Конфиг или подписка» ([5767656](https://github.com/abubakrmuminov/belazvpn/commit/5767656e13d0c3817ebf46dd659528f8ab69cdc6))
* **recurrent:** цена автопродления учитывает докупки устройств и трафика ([85344c6](https://github.com/abubakrmuminov/belazvpn/commit/85344c663e7c5f5b99761d8ad06aebdac7916a4f))
* **redis:** убрать шум «Failed to enable maintenance notifications» на каждом соединении ([e4a7b9f](https://github.com/abubakrmuminov/belazvpn/commit/e4a7b9f7dcb88c7bff018382b47bcdb729395090))
* **referral:** close five traps in the bot level editor ([f7f4e65](https://github.com/abubakrmuminov/belazvpn/commit/f7f4e65d51dd51ac03f3807134ca9b9216cb9965))
* **referral:** close the hazards an adversarial audit found in the levels scheme ([72ae99b](https://github.com/abubakrmuminov/belazvpn/commit/72ae99bc4483c639b3129f0726a59f03f5f224d9))
* **referral:** close what an adversarial review of the levels feature found ([28aaf80](https://github.com/abubakrmuminov/belazvpn/commit/28aaf804eb630211ad74f26cee8d987904ddaa50))
* **referral:** close what an execution audit found in day granting and the editor ([da1a820](https://github.com/abubakrmuminov/belazvpn/commit/da1a82082ce0777e0ab4edb45123ef734306e60d))
* **referral:** close what the UX review found in the bot ([c08d42b](https://github.com/abubakrmuminov/belazvpn/commit/c08d42b9cf08e96b3e024b2b24d55f610e928b0c))
* **referral:** finish the level surface — localization, depth, remaining totals ([223a8dd](https://github.com/abubakrmuminov/belazvpn/commit/223a8ddcddeb78431ff84d100c3d4196684b105a))
* **referral:** make a fresh install and an upgraded one reach the same schema ([01190d7](https://github.com/abubakrmuminov/belazvpn/commit/01190d70a74b5e025933d14ce7f0d5ebe75b86f7))
* **referral:** repair a leaked mutation and close a verification pass ([ecdaa68](https://github.com/abubakrmuminov/belazvpn/commit/ecdaa681f416e60e76362238741bfcbc0d42a0ed))
* **referral:** scope the payment cap to its level, and import the right percent ([6e4556c](https://github.com/abubakrmuminov/belazvpn/commit/6e4556c5e94caacc2886a710bf85bf18a11be989))
* **referral:** send day rewards to the paid subscription, not whichever comes first ([9bce186](https://github.com/abubakrmuminov/belazvpn/commit/9bce18618f6ac8f0df20cd86bea2606190d9fd40))
* **referral:** stop dropping tariff-targeted days for users subscribed elsewhere ([1670d7f](https://github.com/abubakrmuminov/belazvpn/commit/1670d7fca66aa693f0c9a3fa74d36e563eaa5229))
* **referral:** вернуть реферальным настройкам редактируемость из админки ([8112f3c](https://github.com/abubakrmuminov/belazvpn/commit/8112f3c66dc3de39d8d78350644f674a7c287e87))
* **referral:** закрыть остальное, что нашла проверка фичи ([104e595](https://github.com/abubakrmuminov/belazvpn/commit/104e595f7494ee2673338eb4c39c9d63340c2134))
* **referral:** не обещать процент, который не может начислиться, и вернуть тариф в миниапп ([3a8273e](https://github.com/abubakrmuminov/belazvpn/commit/3a8273e56397061c4624c823d4eacae2b612cd29))
* **referral:** не оставлять взведённым ввод глубины и не врать про процент ([889b5fd](https://github.com/abubakrmuminov/belazvpn/commit/889b5fd2ef2b61eff7dee37459ae568bb4e4f3b7))
* **referral:** не терять ответ на callback и не врать про процент партнёра ([40f746e](https://github.com/abubakrmuminov/belazvpn/commit/40f746e1432fe4654e63dde4c7b39ac7a8ec610f))
* **referral:** письмо о регистрации реферала — «Новый реферал», а не «Реферальный бонус: +0 ₽» ([92dd70a](https://github.com/abubakrmuminov/belazvpn/commit/92dd70a1a9317582d7f18ab61d849c209b568656))
* **referral:** подписка под награду появляется в панели — sync выбирает create или update ([118fe1b](https://github.com/abubakrmuminov/belazvpn/commit/118fe1be3f43c71a88fdd10b84104202be41282c))
* **referral:** применять лимит выплат к начислению той же секунды ([43140f0](https://github.com/abubakrmuminov/belazvpn/commit/43140f09584f0140d80c64ff501b9f316b380eda))
* **remnawave:** grace-сессия строки-донора не теряет идентичность ([dc09e78](https://github.com/abubakrmuminov/belazvpn/commit/dc09e78077d00c02b3dc3e16a4e846bcf1cbed30))
* **remnawave:** бэкфил не блокируется одной парой и отдаёт id живой строке ([5cd3adb](https://github.com/abubakrmuminov/belazvpn/commit/5cd3adb5bd856ca54d984bb4f9f59ce33a097b0d))
* **remnawave:** бэкфил не откатывался целиком на single-tariff ([d461784](https://github.com/abubakrmuminov/belazvpn/commit/d461784f3c70cb58c7dd11fc9c51b60be0190ae8))
* **remnawave:** бэкфилл падал на старте и брал не тот режим ([deeb24f](https://github.com/abubakrmuminov/belazvpn/commit/deeb24fbcdd235f63892b50d2ca478b2c6ac6325))
* **remnawave:** бэкфилл привязывал чужой аккаунт, создание падало на индексе ([98e63b0](https://github.com/abubakrmuminov/belazvpn/commit/98e63b07b5c8e8c562c1e96936049f057257d2d8))
* **remnawave:** вебхук не проверял соседей, и подписи тестов врали ([70d35c1](https://github.com/abubakrmuminov/belazvpn/commit/70d35c1afee123938ce833688120dc2397855d98))
* **remnawave:** защита от противоречивых uuid не работала на первом прогоне ([928ce20](https://github.com/abubakrmuminov/belazvpn/commit/928ce20a011618ee4793bc50c068eafde65e0946))
* **remnawave:** истёкшей подписке больше не переписывается дата окончания в панели ([5b24d67](https://github.com/abubakrmuminov/belazvpn/commit/5b24d67a1febe903637875391c96da70f7e5e7bb))
* **remnawave:** карта uuid не праймилась, холостой прогон писал в БД ([e9445ee](https://github.com/abubakrmuminov/belazvpn/commit/e9445ee2f12c811965e4936687258d79152c707a))
* **remnawave:** клэмп size в 1..1000 для /api/users/stream ([7bf8047](https://github.com/abubakrmuminov/belazvpn/commit/7bf8047e8bde7c56b55680cbc9e18f45f6765fc1))
* **remnawave:** ложный успех при удалении устройств, окно суток и happ-ссылка ([b007de8](https://github.com/abubakrmuminov/belazvpn/commit/b007de8f4117d4626a03fd3c54316a1e34aaaee6))
* **remnawave:** не подставлять None вместо класса ошибки при провале импорта ([775e507](https://github.com/abubakrmuminov/belazvpn/commit/775e5075769bc8ff892b8b359a6f03a4f1e12d1d))
* **remnawave:** не терять и не подсовывать протухшую идентичность подписки ([bef6e6d](https://github.com/abubakrmuminov/belazvpn/commit/bef6e6d7d1db65660800b58e7fc20856f40b0751))
* **remnawave:** несовпадение владельца снова вело к очистке, а не к перепривязке ([ea4db92](https://github.com/abubakrmuminov/belazvpn/commit/ea4db928b3d9dd171af3d00b8f9c706d4cc47fca))
* **remnawave:** повторный прогон бэкфила и выбор живой подписки ([b515c3d](https://github.com/abubakrmuminov/belazvpn/commit/b515c3d30bb762f89b425069d5685d8750168ce0))
* **remnawave:** поля, которых нет в контракте 3.0.0, и след прогона бэкфила ([babf846](https://github.com/abubakrmuminov/belazvpn/commit/babf84634d676a71e7c2b77f03ec7aadaefb391f))
* **remnawave:** порядок UPDATE'ов при переносе панельного id ([28b01f1](https://github.com/abubakrmuminov/belazvpn/commit/28b01f1ee71841a2d9654e357c26729f8a6f09af))
* **remnawave:** протухший id больше не решает за пользователя ([83c6415](https://github.com/abubakrmuminov/belazvpn/commit/83c6415c11d007151dde99dfea61178382ba1e8a))
* **remnawave:** режим disable запрещает удалять аккаунт панели при сбросе триала ([47427f8](https://github.com/abubakrmuminov/belazvpn/commit/47427f8d5eb5821393c44fac05b62f0c0f9adbff))
* **remnawave:** след прогона врал, а защита индекса не мешала записи в панель ([fe3dc5b](https://github.com/abubakrmuminov/belazvpn/commit/fe3dc5bb42cef0b1becbaa56c6ad9be3076c9276))
* **remnawave:** суточная проверка снова не сработала бы, а граница id ослабла ([3c31285](https://github.com/abubakrmuminov/belazvpn/commit/3c31285a4c920b715dc57253c6525af82972a5b6))
* **remnawave:** точный ключ не должен проигрывать догадке и ронять синк ([d2fd3d5](https://github.com/abubakrmuminov/belazvpn/commit/d2fd3d5db91ed82aea639b5602dc9f900aeaa18b))
* **remnawave:** холостой прогон бэкфила называл свой отчёт «conflicts» ([6b7204b](https://github.com/abubakrmuminov/belazvpn/commit/6b7204b1d5cf5a1a6e4cffa9972aef9f55995500))
* **rich-menu:** RICH_MESSAGE_DATE_INVALID на подписках дальше ~3 лет ([9ee31d3](https://github.com/abubakrmuminov/belazvpn/commit/9ee31d3d57e5fcac58bb26886b256ab62fb6884b))
* **rich-menu:** дать включить rich-меню без логотипа ([add7327](https://github.com/abubakrmuminov/belazvpn/commit/add7327d479202e8c12a232eeb7fd4b28157da25))
* **rich-menu:** премиум-эмодзи из текстов меню уходили клиенту сырым тегом ([1feab43](https://github.com/abubakrmuminov/belazvpn/commit/1feab432bc4da949ecbf15e7729320990272af30))
* **rich:** make usernames clickable ([42ff65a](https://github.com/abubakrmuminov/belazvpn/commit/42ff65a97b14f2d6cc88408785e74d9d5ee79ff2))
* **rich:** ссылку на профиль ставим только настоящему Telegram-логину ([accda9a](https://github.com/abubakrmuminov/belazvpn/commit/accda9aa0a69dc1b2fb34d0c9ab036c722020b7e))
* **search:** регистронезависимый поиск по юзерам для кириллицы ([5323803](https://github.com/abubakrmuminov/belazvpn/commit/53238035f72b4a1ee7554196d0899e9bde23d6df))
* **security:** линейная проверка HTML вместо квадратичной ([a248cea](https://github.com/abubakrmuminov/belazvpn/commit/a248cea2a9e9f7e82d9945c732eadeabb6b8e5e3))
* **security:** линейная проверка HTML вместо квадратичной ([38c0b06](https://github.com/abubakrmuminov/belazvpn/commit/38c0b0663f1f671455206570341e3b57f19f827f))
* **security:** линейное вырезание тегов вместо квадратичного ([34879b1](https://github.com/abubakrmuminov/belazvpn/commit/34879b11c7411ee5df5765ded7cff053b1fa672e))
* **settings:** булеву настройку со списком вариантов нельзя было сохранить ([1ee5f60](https://github.com/abubakrmuminov/belazvpn/commit/1ee5f6087a08f1877c313812a7c78a77af705b47))
* **settings:** осмысленные категории для настроек, начинающихся с глагола ([e6f1505](https://github.com/abubakrmuminov/belazvpn/commit/e6f150537ad57b24f95f9f7024d0d329c5cd6c56))
* **settings:** отображать DEVICES_SELECTION_DISABLED_AMOUNT как число, а не цену ([0f1968e](https://github.com/abubakrmuminov/belazvpn/commit/0f1968ec658148f0920bfaa253ea3c59c9f6df1f)), closes [#1658](https://github.com/abubakrmuminov/belazvpn/issues/1658)
* **startup:** однозначно широкие статус-значки в резюме запуска ([3dae638](https://github.com/abubakrmuminov/belazvpn/commit/3dae638755499094d405601a9fe81eecf5389fbc))
* **start:** видео не доходило до самой команды /start ([1f61e0b](https://github.com/abubakrmuminov/belazvpn/commit/1f61e0bec2686314f7e151b00d4b4e616e749329))
* **subscription:** device_limit = 0 — это безлимит, а не ноль устройств ([51688fc](https://github.com/abubakrmuminov/belazvpn/commit/51688fc4573569dae2fe9855da93eeebb6d1188a))
* **subscription:** не показывать неоплаченный черновик триала как подписку ([fe992c6](https://github.com/abubakrmuminov/belazvpn/commit/fe992c65817eff1156f2f7d56232d59a1bf385fe))
* **subscription:** применять DEFAULT_AUTOPAY_ENABLED и в classic-режиме ([a2afbf9](https://github.com/abubakrmuminov/belazvpn/commit/a2afbf91999e98e6b79b6a9328e5d807dfece1ae))
* **subscription:** шифровать только incy-ссылки импорта подписки ([9c38c43](https://github.com/abubakrmuminov/belazvpn/commit/9c38c4306a8e3ad8720a9a0d0091fc56d0679061))
* **support:** дефолты SLA в коде развести с .env.example не в пользу спама ([38110e5](https://github.com/abubakrmuminov/belazvpn/commit/38110e50fee3a8d57f42c66a72f238582e5a2a28))
* **support:** отдавать внешний URL поддержки в конфиге кабинета ([b270349](https://github.com/abubakrmuminov/belazvpn/commit/b27034969f11d6bf41e4e8a81da351fabcb965f4))
* **support:** проверять бан поддержки и режим тикетов в веб-сокете ([f3acc69](https://github.com/abubakrmuminov/belazvpn/commit/f3acc69a8fcae3efdbd5a18153a05a75473a4136))
* **support:** синхронизировать persisted-режим поддержки в settings при старте ([2184e58](https://github.com/abubakrmuminov/belazvpn/commit/2184e58da48831c914ac68806baa13008d3f0a85))
* **tariffs:** в последний день подписки переключение тарифа больше не бесплатное ([fd9b2cc](https://github.com/abubakrmuminov/belazvpn/commit/fd9b2ccc70e147258a85ba7ac8bad8a440c3a32c))
* **tariff:** превью покупки считает цену тем же PricingEngine, что и confirm ([baef285](https://github.com/abubakrmuminov/belazvpn/commit/baef285194868a8c422833b37f33b0e941abc547))
* **tariff:** СБП-оформление доступно с экрана «недостаточно средств» ([a5a13ae](https://github.com/abubakrmuminov/belazvpn/commit/a5a13aea1d9249b4dc7eca8b1c4851e9acaa337e))
* **tests:** подписка панели импортируется только модулем ([518ee41](https://github.com/abubakrmuminov/belazvpn/commit/518ee41d4dbde816eb1e308cf75cd0d39443f57d))
* **tickets:** длинные сообщения обрезались и не показывались целиком ([064e067](https://github.com/abubakrmuminov/belazvpn/commit/064e0673b86db4195a85ec5eaf5e349e3324fef2))
* **tickets:** длинные сообщения обрезались и не показывались целиком ([3be6da7](https://github.com/abubakrmuminov/belazvpn/commit/3be6da7a8c6c8fc423d110850f1376207c82d2d1))
* **tickets:** не глушить ответ поддержки глобальным тумблером и завести шаблон в редакторе ([7902361](https://github.com/abubakrmuminov/belazvpn/commit/790236143e3f92592ba49f5af1d48329763516e3))
* **tickets:** передавать db в новые event_emitter-эмиссии кабинета ([8eaef7f](https://github.com/abubakrmuminov/belazvpn/commit/8eaef7f1ffbddc7947d591a87aaeaa643b3f9cfa))
* **tickets:** проверять блокировку поддержки и лимит тикетов в кабинете ([2887ef7](https://github.com/abubakrmuminov/belazvpn/commit/2887ef70cadbe85b15e974429ac0e5d283c80515))
* **tickets:** режим поддержки в кабинете читать у сервиса, а не из settings ([bd93d7e](https://github.com/abubakrmuminov/belazvpn/commit/bd93d7e8ba7e3908fc73684c5782ef9d633fd065))
* **tickets:** экранировать превью ответа в уведомлении пользователю ([f898414](https://github.com/abubakrmuminov/belazvpn/commit/f898414bb4dfca6350d02242088bae44fe7fce8d))
* **traffic:** не читать даты периода вне ветки, которая их задаёт ([993ea75](https://github.com/abubakrmuminov/belazvpn/commit/993ea75c90ebc769d6fe064c21f8fbf05bfc28d9))
* **tribute:** per-событийный ключ идемпотентности вместо donation_request_id ([e9515ad](https://github.com/abubakrmuminov/belazvpn/commit/e9515adb725f121d5b13b174c6ea8933228fbb17))
* восстановить забытые импорты, падавшие NameError в проде ([9bedd81](https://github.com/abubakrmuminov/belazvpn/commit/9bedd81c1f6c2e44aaf8ff299bd3db7e7848df1d))
* объявить литеральные пути уровней наград выше /{user_id} ([94df5bb](https://github.com/abubakrmuminov/belazvpn/commit/94df5bbf3adafb4f3faa287fba9f0b9fef207f4a))
* подчистить старые замечания code scanning — пустые except, ожидание отменённых задач, setuptools в образе ([e9607b5](https://github.com/abubakrmuminov/belazvpn/commit/e9607b59a3fe1bd98bd8c1dda4f19d5dce75012f))
* пустые except в тикетах, подписках и панели — причина в лог; из образа убраны системные pip и setuptools ([15a393d](https://github.com/abubakrmuminov/belazvpn/commit/15a393df3db78435bf09313b76318d4d93a84a32))
* устранить замечания CodeQL из PR [#3123](https://github.com/abubakrmuminov/belazvpn/issues/3123) ([c7cc8b4](https://github.com/abubakrmuminov/belazvpn/commit/c7cc8b4585b94766be87fd5a260ec8f436a5b7a8))


### Performance

* **etoplatezhi:** ack webhook instantly, process callback in background ([2acea3f](https://github.com/abubakrmuminov/belazvpn/commit/2acea3f6c369f104c2244404474f3611afbbfe96))


### Refactoring

* **campaigns:** вынести привязку к кампании в сервис ([a813083](https://github.com/abubakrmuminov/belazvpn/commit/a813083c7a2140b1193c1ff10cb4a7809f5e95e3))
* share gift activation across channels ([b42b75d](https://github.com/abubakrmuminov/belazvpn/commit/b42b75d524d8aba415f7688bccb03c9c50ea7b39))
* share gift checkout domain with bot ([e41d655](https://github.com/abubakrmuminov/belazvpn/commit/e41d6552090cd8006da169e69e8169a6022057ab))
* убраны замечания статического анализа с релизного PR ([70d4bf9](https://github.com/abubakrmuminov/belazvpn/commit/70d4bf97ec953a3ec5854f9ebfa8bdacf8887f5b))


### Documentation

* **handoff:** состояние интеграций TabPay и ParityPay ([6e69046](https://github.com/abubakrmuminov/belazvpn/commit/6e690461f9757d40c852c807950e49484298417f))
* **handoff:** тесты на PostgreSQL, прогон в CI и аудит тихих дыр ([01a1060](https://github.com/abubakrmuminov/belazvpn/commit/01a1060a08c2f771e78379349ff9c55ead1d9804))
* **platega:** отмена автооплаты, хук при удалении подписки, админка кабинета ([47f5252](https://github.com/abubakrmuminov/belazvpn/commit/47f5252ffcc188557907dfd8c0c20529c3f06ad6))
* **platega:** план реализации бэкенда+бота рекуррентных СБП (Plan A) ([7a8bd2e](https://github.com/abubakrmuminov/belazvpn/commit/7a8bd2ee1358f65e4f140f88194d6d02dfd77c83))
* **platega:** спека рекуррентных СБП-платежей Platega ([9f876aa](https://github.com/abubakrmuminov/belazvpn/commit/9f876aa2836c15358995c31d092a86edd90e4467))
* **reachability:** рабочие спека и планы вынесены из репозитория, ссылки переписаны ([bfd179b](https://github.com/abubakrmuminov/belazvpn/commit/bfd179b67514703d2b46f598e26180d4328678dd))
* **reachability:** спецификация и планы интеграции bschekbot API ([1675b1e](https://github.com/abubakrmuminov/belazvpn/commit/1675b1efae37e7de40e97f2f7df02e5f035f1471))
* **readme:** добавить CisPay в список провайдеров и закрыть пропуск тестом ([33d3913](https://github.com/abubakrmuminov/belazvpn/commit/33d3913309c2a9f07e6fa1387c00a25911e56122))
* **remnawave:** точное обоснование раздельных flush при переносе id ([6eb80c6](https://github.com/abubakrmuminov/belazvpn/commit/6eb80c6957987a48098bfffe2b11701dc4267285))
* **structure:** обновить справку под тест обёртки ([1c4dbdf](https://github.com/abubakrmuminov/belazvpn/commit/1c4dbdf1ab434271eebea3bc806cfb87b97ae254))
* **structure:** собирать справку по структуре из кода, а не вести руками ([74e6647](https://github.com/abubakrmuminov/belazvpn/commit/74e664781c741e8682c665d42ffc2bca6271067a))
* обновить справочник структуры после удаления ручки retrieve ([4bde5b7](https://github.com/abubakrmuminov/belazvpn/commit/4bde5b7e6493a8153cfd4d736d5952b80566b4cc))
* пересобрать справочник структуры после новых тестов согласия ([354292b](https://github.com/abubakrmuminov/belazvpn/commit/354292b9baeefef3fbb15be3e7fd86589380d5a0))
* пересобрать справочник структуры после тестов плитки фавикона ([9de0173](https://github.com/abubakrmuminov/belazvpn/commit/9de0173d6d7838a5b77442645e3b30c15309633f))
